...
- The execution model uses a tiered partial-close scheme: strong setups cash out portions at 0.3R and 0.5R, normal setups at 0.3R, and weak setups at 0.15R. Prefer the earliest clean continuation entry instead of waiting for extra confirmation.
...
- Each trade decision must be fully independent. Do not consider prior trade outcomes, lessons, or feedback.
...
class MT5V51EntryAnalystAgent:
    ...
    def build_prompt(self, context_packet: dict[str, object]) -> str:
        return (
            ...
            'The execution model uses tiered partial closes per setup quality: strong cashes out at 0.3R and 0.5R, normal at 0.3R, weak at 0.15R. Prefer the earliest clean continuation or pause-after-impulse entry instead of waiting for more candles.\n'
            ...
            'Each decision must be fully independent. Do not consider prior trades, feedback, or lessons.\n'
