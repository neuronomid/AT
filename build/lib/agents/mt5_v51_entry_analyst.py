...
class MT5V51EntryAnalystAgent:
    ...
    def build_prompt(self, context_packet: dict[str, object]) -> str:
        return (
            ...
            'Example short: {"action":"enter_short","confidence":0.74,"rationale":"trend_regime is a tradeable bearish burst, recent_bars.1m show orderly downside follow-through, and the 20s tape is confirming or neutral","thesis_tags":["momentum","breakdown"],"requested_risk_fraction":0.003,"context_signature":"..."}\n'
